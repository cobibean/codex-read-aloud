...
It does not auto-read every chat. Ask your agent to use it when you want audio, stop it from chat or a launcher app, and use either built-in macOS voices or OpenAI TTS.
